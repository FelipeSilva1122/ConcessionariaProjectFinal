...
=======
$imagem_veiculo = "http://locadoraads.herokuapp.com/upload/";
  ...
  <div class="tabela_cliente">
      ...
      <ul class="lista_veiculos">
          ...
          <li>
            ...
            <div class="item_veiculo"><img src="<?php echo $imagem_veiculo . $dados_veiculo['imagem_veiculo'];?>" alt="Imagem do veículo"></div>
            <?php } ?>
